import { Kind, GraphQLDirective, valueFromASTUntyped, GraphQLInputObjectType, GraphQLScalarType, GraphQLUnionType, GraphQLEnumType, GraphQLInterfaceType, GraphQLObjectType, DirectiveLocation, TokenKind, getDirectiveValues, GraphQLDeprecatedDirective, isObjectType, isInputObjectType, isInterfaceType, isUnionType, isEnumType, isScalarType, isNamedType, getNamedType, isSpecifiedScalarType, GraphQLSchema, isLeafType, print, specifiedDirectives, extendSchema } from 'graphql';
            ...
            if (mergeTypes === true ||
                ...
                typeCandidates[typeName].forEach(typeCandidate => {
                    ...
                    if (mergedTypeConfig.resolve != null) {
                        ...
                        mergedTypeConfig.resolve = (originalResult, context, info, subschema, selectionSet) => batchDelegateToSchema({
                            schema: subschema,
                            operation: 'query',
